...
Theme = {
    ['Lapis'] = {
        ...
        ['Color Main']                      = Color3.fromRGB(59, 130, 246),

        ['Color Tab'] = {
            [1] = Color3.fromRGB(30, 58, 138),
            [2] = Color3.fromRGB(37, 99, 235)
        },

        ['Top Bar']                         = Color3.fromRGB(23, 33, 63),
        ['Text Color']                      = Color3.fromRGB(235, 239, 255),
        ['Text Tab Select']                 = Color3.fromRGB(255, 255, 255),
        ['Tab Bar']                         = Color3.fromRGB(18, 28, 58),

        ['Background Page']                 = Color3.fromRGB(26, 35, 63),
        ['Line Page']                       = Color3.fromRGB(70, 90, 150),
        ['Top Bar Page']                    = Color3.fromRGB(23, 33, 63),
        ['Search']                          = Color3.fromRGB(45, 55, 95),

        ['Background Function']             = Color3.fromRGB(47, 70, 120),
        ['Background Function Transparency'] = 0.9,
        ['Background Function Transparency Moved'] = 0.8,

        ['Dropdown Color']                  = Color3.fromRGB(45, 55, 95),
        ['Dropdown Select Background']      = Color3.fromRGB(26, 35, 63),
        ['Dropdown Select Stroke']          = Color3.fromRGB(59, 130, 246),
        ['Dropdown Item']                   = Color3.fromRGB(70, 90, 150),
        ['Textbox Color']                   = Color3.fromRGB(45, 55, 95),
        ['Slider Color']                    = Color3.fromRGB(45, 55, 95),
        ['Toggle Color']                    = Color3.fromRGB(18, 28, 58),
